...
@JeapMessageProducerContract(value = NotifyClientCommand.TypeRef.class, topic = "jme-server-sent-events-scs-notifyclient")
@JeapMessageConsumerContract(value = NotifyClientCommand.TypeRef.class, topic = "jme-server-sent-events-scs-notifyclient")
