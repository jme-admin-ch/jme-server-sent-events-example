...
public class AfterDeploymentSmokeTestIT {
    ...
    private static final String PERSONS_API_PATH = "/jme-server-sent-events-scs/api/persons";
    private static final String SSE_API_PATH = "/jme-server-sent-events-scs/ui-api/sse/events";
    ...
    void createAndDeletePerson() throws Exception {
        ...
        SSEClientTestSupport.SSEClient testClient = SSEClientTestSupport.createTestClient(baseUrl, SSE_API_PATH, 1, true);
        ...
        testClient = SSEClientTestSupport.createTestClient(baseUrl, SSE_API_PATH, 1, true);
